...
class Russia: 
    def __init__(self):
        self.AltaiKrai = CountryElement("Altai Krai")
        self.AltaiRepublic = CountryElement("Altai Republic")
        self.AmurOblast = CountryElement("Amur Oblast")
        self.ArkhangelskOblast = CountryElement("Arkhangelsk Oblast")
        self.AstrakhanOblast = CountryElement("Astrakhan Oblast")
        self.BelgorodOblast = CountryElement("Belgorod Oblast")
        self.BryanskOblast = CountryElement("Bryansk Oblast")
        self.ChechenRepublic = CountryElement("Chechen Republic")
        self.ChelyabinskOblast = CountryElement("Chelyabinsk Oblast")
        self.ChukotkaAutonomousOkrug = CountryElement("Chukotka Autonomous Okrug")
        self.ChuvashRepublic = CountryElement("Chuvash Republic")
        self.IrkutskOblast = CountryElement("Irkutsk Oblast")
        self.IvanovoOblast = CountryElement("Ivanovo Oblast")
        self.JewishAutonomousOblast = CountryElement("Jewish Autonomous Oblast")
        self.KabardinoBalkarRepublic = CountryElement("Kabardino Balkar Republic")
        self.KaliningradOblast = CountryElement("Kaliningrad Oblast")
        self.KalugaOblast = CountryElement("Kaluga Oblast")
        self.KamchatkaKrai = CountryElement("Kamchatka Krai")
        self.KarachayCherkessRepublic = CountryElement("Karachay Cherkess Republic")
        self.KemerovoOblast = CountryElement("Kemerovo Oblast")
        self.KhabarovskKrai = CountryElement("Khabarovsk Krai")
        self.KhantyMansiAutonomousOkrug = CountryElement("Khanty Mansi Autonomous Okrug")
        self.KirovOblast = CountryElement("Kirov Oblast")
        self.KomiRepublic = CountryElement("Komi Republic")
        self.KostromaOblast = CountryElement("Kostroma Oblast")
        self.KrasnodarKrai = CountryElement("Krasnodar Krai")
        self.KrasnoyarskKrai = CountryElement("Krasnoyarsk Krai")
        self.KurganOblast = CountryElement("Kurgan Oblast")
        self.KurskOblast = CountryElement("Kursk Oblast")
        self.LeningradOblast = CountryElement("Leningrad Oblast")
        self.LipetskOblast = CountryElement("Lipetsk Oblast")
        self.MagadanOblast = CountryElement("Magadan Oblast")
        self.MariElRepublic = CountryElement("Mari El Republic")
        self.Moscow = CountryElement("Moscow")
        self.MoscowOblast = CountryElement("Moscow Oblast")
        self.MurmanskOblast = CountryElement("Murmansk Oblast")
        self.NenetsAutonomousOkrug = CountryElement("Nenets Autonomous Okrug")
        self.NizhnyNovgorodOblast = CountryElement("Nizhny Novgorod Oblast")
        self.NovgorodOblast = CountryElement("Novgorod Oblast")
        self.NovosibirskOblast = CountryElement("Novosibirsk Oblast")
        self.OmskOblast = CountryElement("Omsk Oblast")
        self.OrenburgOblast = CountryElement("Orenburg Oblast")
        self.OryolOblast = CountryElement("Oryol Oblast")
        self.PenzaOblast = CountryElement("Penza Oblast")
        self.PermKrai = CountryElement("Perm Krai")
        self.PrimorskyKrai = CountryElement("Primorsky Krai")
        self.PskovOblast = CountryElement("Pskov Oblast")
        self.RepublicofAdygea = CountryElement("Republic of Adygea")
        self.RepublicofBashkortostan = CountryElement("Republic of Bashkortostan")
        self.RepublicofBuryatia = CountryElement("Republic of Buryatia")
        self.RepublicofCrimea = CountryElement("Republic of Crimea")
        self.RepublicofDagestan = CountryElement("Republic of Dagestan")
        self.RepublicofIngushetia = CountryElement("Republic of Ingushetia")
        self.RepublicofKalmykia = CountryElement("Republic of Kalmykia")
        self.RepublicofKarelia = CountryElement("Republic of Karelia")
        self.RepublicofKhakassia = CountryElement("Republic of Khakassia")
        self.RepublicofMordovia = CountryElement("Republic of Mordovia")
        self.RepublicofNorthOssetiaAlania = CountryElement("Republic of North Ossetia Alania")
        self.RepublicofTatarstan = CountryElement("Republic of Tatarstan")
        self.RostovOblast = CountryElement("Rostov Oblast")
        self.RyazanOblast = CountryElement("Ryazan Oblast")
        self.SakhaRepublic = CountryElement("Sakha Republic")
        self.SakhalinOblast = CountryElement("Sakhalin Oblast")
        self.SamaraOblast = CountryElement("Samara Oblast")
        self.SaratovOblast = CountryElement("Saratov Oblast")
        self.Sevastopol = CountryElement("Sevastopol")
        self.SmolenskOblast = CountryElement("Smolensk Oblast")
        self.StPetersburg = CountryElement("St Petersburg")
        self.StavropolKrai = CountryElement("Stavropol Krai")
        self.SverdlovskOblast = CountryElement("Sverdlovsk Oblast")
        self.TambovOblast = CountryElement("Tambov Oblast")
        self.TomskOblast = CountryElement("Tomsk Oblast")
        self.TulaOblast = CountryElement("Tula Oblast")
        self.TuvaRepublic = CountryElement("Tuva Republic")
        self.TverOblast = CountryElement("Tver Oblast")
        self.TyumenOblast = CountryElement("Tyumen Oblast")
        self.UdmurtRepublic = CountryElement("Udmurt Republic")
        self.UlyanovskOblast = CountryElement("Ulyanovsk Oblast")
        self.VladimirOblast = CountryElement("Vladimir Oblast")
        self.VolgogradOblast = CountryElement("Volgograd Oblast")
        self.VologdaOblast = CountryElement("Vologda Oblast")
        self.VoronezhOblast = CountryElement("Voronezh Oblast")
        self.YamaloNenetsAutonomousOkrug = CountryElement("Yamalo Nenets Autonomous Okrug")
        self.YaroslavlOblast = CountryElement("Yaroslavl Oblast")
        self.ZabaykalskyKrai = CountryElement("Zabaykalsky Krai")
